...
crash a read-side walk". Write-time validation (:mod:`canonic.knowledge.validation`) already
...
class DefinitionRenderer:
    ...
    The index is injected once (mirroring :class:`~canonic.knowledge.validation.ReferenceValidator`);
