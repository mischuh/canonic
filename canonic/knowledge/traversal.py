...
dedupes, and returns the connected :class:`~canonic.knowledge.results.Subgraph` — the pages
...
.. note::
   ...
   :class:`~canonic.knowledge.retrieval.KnowledgeSearch`) and ``entity_index`` becomes the
...
from canonic.knowledge.results import Subgraph
from canonic.knowledge.validation import iter_wikilink_slugs
