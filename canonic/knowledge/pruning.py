...
The write-time counterpart in :mod:`canonic.knowledge.validation` blocks a page that points
...
against the live indexes and emits an E4 :class:`~canonic.ingestion.models.Proposal`. It writes
...
from canonic.ingestion.models import DraftedBy, Proposal, ProposalOp
...
# semantic-source prune in canonic.ingestion.reconciliation.
...
class PruneAdvisor:
    ...
    def stale_sl_refs(page: KnowledgePage, entity_index: EntityIndex) -> list[str]:
        ...
        :meth:`~canonic.knowledge.validation.EntityIndex.__contains__`.
        """
    ...
    def stale_refs(page: KnowledgePage, page_index: PageIndex) -> list[str]:
        ...
        :class:`~canonic.knowledge.validation.ReferenceValidator` so prune and validate agree.
        """
