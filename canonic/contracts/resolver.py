...
onto the same-named exception in :mod:`canonic.exc` (which carries the headless error
...
class Ambiguous:
    ...
    Distinct from :class:`canonic.exc.Ambiguous` (the exception with an error code).
    """
...
class Unresolved:
    ...
    Distinct from :class:`canonic.exc.Unresolved` (the exception with an error code).
    """
