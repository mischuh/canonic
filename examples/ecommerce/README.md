...
```sh
canonic --json query --metrics revenue --dimensions order_date
```
...
```sh
canonic --json query --metrics revenue,order_count --dimensions country
```
...
canonic --json query --metrics mrr   # stderr: {"code": "unresolved", "message": "…"}
echo $?                             # 2
```
